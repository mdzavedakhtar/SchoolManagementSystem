  ...
  const pillars = [
    {
      ...
      description: "Personalized academic guidance tailored to every student's learning pace and conceptual needs.",
      icon: UserCheck,
    },
    {
      number: "02",
      title: "Academic Excellence",
      description: "Rigorous CBSE-pattern school education complemented by result-driven coaching methodologies.",
      icon: Award,
    },
    {
      number: "03",
      title: "Hindi & English Medium",
      description: "Clear, accessible instruction in both Hindi and English mediums to ensure complete comprehension.",
      icon: Languages,
    },
    {
      number: "04",
      title: "Dedicated Guidance",
      description: "Attentive faculty commitment focused on discipline, regular practice, and conceptual clarity.",
      icon: Compass,
    },
    {
      number: "05",
      title: "Competitive Preparation",
      description: "Specialized target preparation for Polytechnic and Paramedical entrance exams alongside regular studies.",
      icon: Target,
    },
    {
      number: "06",
      title: "Holistic Development",
      description: "Nurturing academic knowledge, moral values, and confidence for a successful future.",
      icon: Sparkles,
    },
  ];
